...
def setup_platform(hass, config, add_entities, discovery_info=None):
    ...
    if ip_addr not in known_devices:
        ...
        add_entities([SamsungTVDevice(host, port, name, timeout, mac, uuid, sourcelist, applist)])
...
class SamsungTVDevice(MediaPlayerDevice):
    ...
    def __init__(self, host, port, name, timeout, mac, uuid, sourcelist, applist):
        ...
        from .samsungctl import Application
        from .samsungctl import Upnp
        import wakeonlan
    ...
    def select_source(self, source):
        ...
        #         self.send_key(self._sourcelist[source])
            # if source == 'TV':
            #     self.send_key("KEY_TV")
            #     self._current_source = 'TV'
            # elif source == 'HDMI':
            #     self.send_key("KEY_HDMI")
            #     self._current_source= 'HDMI'
            # elif source == 'TV/HDMI':
            #     self.send_key("KEY_HDMI")
            #     self._current_source= 'TV/HDMI'
